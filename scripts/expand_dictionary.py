...
GOOGLE_FREQ = "https://raw.githubusercontent.com/first20hours/google-10000-english/master/google-10000-english-no-swears.txt"
...
def request_bytes(url: str) -> bytes:
    req = urllib.request.Request(url, headers={"User-Agent": "word-logic-relay-dictionary-builder/3.0"})
...
Generated by `scripts/expand_dictionary.py` from pinned baseline commit `{BASELINE_COMMIT}`.
